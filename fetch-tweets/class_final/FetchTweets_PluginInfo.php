...
final class FetchTweets_PluginInfo {
	
	// Properties
	private $strPluginFilePath;	// Stores the plugin main script path. Should be set with the constructor.
	...
	private function getPluginInfo( $strFilePath ) {
		...
		// The get_file_data() function is defined in /wp-includes/functions.php so it's safe to use that.
