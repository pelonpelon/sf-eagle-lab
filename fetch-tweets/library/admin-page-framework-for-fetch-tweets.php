...
if ( ! class_exists( 'FetchTweets_AdminPageFramework_WPUtilities' ) ) :
/**
 ...
 */
abstract class FetchTweets_AdminPageFramework_WPUtilities {
	...
	static public function getSRCFromPath( $strFilePath ) {
		...
		$strRelativePath = '/' . FetchTweets_AdminPageFramework_Utilities::getRelativePath( ABSPATH, $strFilePath );
...
if ( ! class_exists( 'FetchTweets_AdminPageFramework_Utilities' ) ) :
/**
 * Provides utility methods which do not use WordPress functions.
 *
 * @since			2.0.0
 * @extends			FetchTweets_AdminPageFramework_WPUtilities
 * @package			Admin Page Framework
 * @subpackage		Admin Page Framework - Utility
 */
class FetchTweets_AdminPageFramework_Utilities extends FetchTweets_AdminPageFramework_WPUtilities {
...
if ( ! class_exists( 'FetchTweets_AdminPageFramework_Help_Base' ) ) :
/**
 * Provides base methods and properties for manipulating the contextual help tabs.
 * 
 * @since			2.1.0
 */
abstract class FetchTweets_AdminPageFramework_Help_Base {
...
if ( ! class_exists( 'FetchTweets_AdminPageFramework_MetaBox_Help' ) ) :
/**
 * Provides methods to manipulate the contextual help tab .
 * 
 * @since			2.1.0
 * @extends			FetchTweets_AdminPageFramework_Help_Base
 */
abstract class FetchTweets_AdminPageFramework_MetaBox_Help extends FetchTweets_AdminPageFramework_Help_Base {
	 ...
	 * 
	 * The help tab will be the meta box title and all the added text will be inserted into the content area within the tab.
	 * On contrary to the <em>addHelpTab()</em> method of the FetchTweets_AdminPageFramework_Help class, the help tab title is already determined and the meta box ID and the title will be used.
	 * 
	 * @since			2.1.0
	 * @uses			addHelpText()
	 * @remark			This method just adds the given text into the class property. The actual registration will be performed with the <em>registerHelpTabTextForMetaBox()</em> method.
...
if ( ! class_exists( 'FetchTweets_AdminPageFramework_Help' ) ) :
/**
 * Provides methods to manipulate the help screen sections.
 * 
 * @abstract
 * @remark				Shared with the both FetchTweets_AdminPageFramework and FetchTweets_AdminPageFramework_PostType.
 * @since				2.1.0
 * @package				Admin Page Framework
 ...
 */
abstract class FetchTweets_AdminPageFramework_Help extends FetchTweets_AdminPageFramework_Help_Base {
	...
	protected function addHelpTab( $arrHelpTab ) {
		...
		$arrHelpTab = ( array ) $arrHelpTab + FetchTweets_AdminPageFramework_Help::$arrStructure_HelpTab;
...
if ( ! class_exists( 'FetchTweets_AdminPageFramework_HeadTag_Base' ) ) :
/**
 ...
 * 
 */
abstract class FetchTweets_AdminPageFramework_HeadTag_Base {
	
	function __construct( $oProps ) {
		
		$this->oProps = $oProps;
		$this->oUtil = new FetchTweets_AdminPageFramework_Utilities;
...
if ( ! class_exists( 'FetchTweets_AdminPageFramework_HeadTag_Pages' ) ) :
/**
 ...
 */
class FetchTweets_AdminPageFramework_HeadTag_Pages extends FetchTweets_AdminPageFramework_HeadTag_Base {

	/**
	 * A flag that indicates whether the JavaScript script for media uploader is enqueued.
	 * 
	 * @since			2.0.0
	 * @since			2.1.5			Moved from FetchTweets_AdminPageFramework_SettingsAPI.
	 * @internal
	 */ 
	...
	public function replyToAddStyle() {
		...
		$strStyle = FetchTweets_AdminPageFramework_Properties::$strDefaultStyle . PHP_EOL . $this->oProps->strStyle;
		$strStyle = $this->oUtil->addAndApplyFilters( $oCaller, $this->oUtil->getFilterArrayByPrefix( FetchTweets_AdminPageFramework_Pages::$arrPrefixes['style_'], $this->oProps->strClassName, $strPageSlug, $strTabSlug, false ), $strStyle );
		$strStyleIE = FetchTweets_AdminPageFramework_Properties::$strDefaultStyleIE . PHP_EOL . $this->oProps->strStyleIE;
		$strStyleIE = $this->oUtil->addAndApplyFilters( $oCaller, $this->oUtil->getFilterArrayByPrefix( FetchTweets_AdminPageFramework_Pages::$arrPrefixes['style_'], $this->oProps->strClassName, $strPageSlug, $strTabSlug, false ), $strStyleIE );
		if ( ! empty( $strStyle ) )
			echo 
	...
	public function replyToAddScript() {
		...
		echo "<script type='text/javascript' id='admin-page-framework-script'>"
				. $this->oUtil->addAndApplyFilters( $oCaller, $this->oUtil->getFilterArrayByPrefix( FetchTweets_AdminPageFramework_Pages::$arrPrefixes['script_'], $this->oProps->strClassName, $strPageSlug, $strTabSlug, false ), $this->oProps->strScript )
			. "</script>";		
	...
	public function enqueueStyle( $strSRC, $strPageSlug='', $strTabSlug='', $arrCustomArgs=array() ) {
		...
		$this->oProps->arrEnqueuingStyles[ $strSRCHash ] = $this->oUtil->uniteArrays( 
			...
			FetchTweets_AdminPageFramework_Properties::$arrStructure_EnqueuingScriptsAndStyles
		);
...
if ( ! class_exists( 'FetchTweets_AdminPageFramework_HeadTag_PostType' ) ) :
/**
 ...
 * 
 */
class FetchTweets_AdminPageFramework_HeadTag_PostType extends FetchTweets_AdminPageFramework_HeadTag_Base {
...
if ( ! class_exists( 'FetchTweets_AdminPageFramework_HeadTag_MetaBox' ) ) :
/**
 ...
 * 
 */
class FetchTweets_AdminPageFramework_HeadTag_MetaBox extends FetchTweets_AdminPageFramework_HeadTag_Base {
	 ...
	 * @since			2.0.0
	 * @since			2.1.5			Moved from FetchTweets_AdminPageFramework_MetaBox. Changed the name from addAtyle() to replyToAddStyle().
	 * @remark			A callback for the <em>admin_head</em> hook.
	 */ 	
	public function replyToAddStyle() {
	 ...
	 * @since			2.0.0
	 * @since			2.1.5			Moved from FetchTweets_AdminPageFramework_MetaBox. Changed the name from addScript() to replyToAddScript().
	 * @remark			A callback for the <em>admin_head</em> hook.
	 */ 
	public function replyToAddScript() {
...
if ( ! class_exists( 'FetchTweets_AdminPageFramework_Pages' ) ) :
/**
 * Provides methods to render admin page elements.
 *
 * @abstract
 * @since			2.0.0
 * @since			2.1.0		Extends FetchTweets_AdminPageFramework_Help.
 * @extends			FetchTweets_AdminPageFramework_Help
 * @package			Admin Page Framework
 * @subpackage		Admin Page Framework - Page
 ...
 */
abstract class FetchTweets_AdminPageFramework_Pages extends FetchTweets_AdminPageFramework_Help {
...
if ( ! class_exists( 'FetchTweets_AdminPageFramework_Menu' ) ) :
/**
 * Provides methods to manipulate menu items.
 *
 * @abstract
 * @since			2.0.0
 * @extends			FetchTweets_AdminPageFramework_Pages
 * @package			Admin Page Framework
 * @subpackage		Admin Page Framework - Page
 ...
 */
abstract class FetchTweets_AdminPageFramework_Menu extends FetchTweets_AdminPageFramework_Pages {
	...
	private function registerSubMenuPage( $arrArgs ) {
		...
		$arrArgs = isset( $arrArgs['strType'] ) && $arrArgs['strType'] == 'link' 
			? $arrArgs + FetchTweets_AdminPageFramework_Link::$arrStructure_SubMenuLink	// for link
...
if ( ! class_exists( 'FetchTweets_AdminPageFramework_SettingsAPI' ) ) :
/**
 * Provides methods to add form elements with WordPress Settings API. 
 *
 * @abstract
 * @since		2.0.0
 * @extends		FetchTweets_AdminPageFramework_Menu
 * @package		Admin Page Framework
 * @subpackage	Admin Page Framework - Page
 ...
 */
abstract class FetchTweets_AdminPageFramework_SettingsAPI extends FetchTweets_AdminPageFramework_Menu {
	...
	*/	
	 ...
	 * @remark			the scope must be protected to be accessed from the extended class. The <em>FetchTweets_AdminPageFramework</em> class uses this method in the overloading <em>__call()</em> method.
	...
	protected function renderSettingField( $strFieldID, $strPageSlug ) {
		...
		$oField = new FetchTweets_AdminPageFramework_InputField( $arrField, $this->oProps->arrOptions, $this->arrFieldErrors, $this->oProps->arrFieldTypeDefinitions[ $strFieldType ] );
	...
	public function registerSettings() {
		...
		new FetchTweets_AdminPageFramework_InputFieldTypeDefinitions( $this->oProps->strClassName, $this->oMsg );		
...
// $this->oDebug->logArray( $this->oProps->strStyle );
		...
		private function setFieldHeadTagElements( $arrField ) {
			...
			if ( isset( $GLOBALS['arrFetchTweets_AdminPageFramework']['arrFieldFlags'][ $strFieldType ] ) && $GLOBALS['arrFetchTweets_AdminPageFramework']['arrFieldFlags'][ $strFieldType ] ) return;
			$GLOBALS['arrFetchTweets_AdminPageFramework']['arrFieldFlags'][ $strFieldType ] = true;
 ...
 * <code>class Sample_Admin_Pages extends FetchTweets_AdminPageFramework {
 * ...
 ...
 * @abstract
 * @since			2.0.0
 * @use				FetchTweets_AdminPageFramework_Properties
 * @use				FetchTweets_AdminPageFramework_Debug
 * @use				FetchTweets_AdminPageFramework_Properties
 * @use				FetchTweets_AdminPageFramework_Messages
 * @use				FetchTweets_AdminPageFramework_Link
 * @use				FetchTweets_AdminPageFramework_Utilities
 * @remark			This class stems from several abstract classes.
 * @extends			FetchTweets_AdminPageFramework_SettingsAPI
 * @package			Admin Page Framework
 * @subpackage		Admin Page Framework - Page
 */
abstract class FetchTweets_AdminPageFramework extends FetchTweets_AdminPageFramework_SettingsAPI {
	...
	* @since			2.0.0
	* @access		protected
	* @var			object			an instance of FetchTweets_AdminPageFramework_Properties will be assigned in the constructor.
    */		
	protected $oProps;	
	...
	* @since			2.0.0
	* @access		protected
	* @var			object			an instance of FetchTweets_AdminPageFramework_Debug will be assigned in the constructor.
    */		
	protected $oDebug;
	...
	* @since			2.0.0
	* @access		protected
	* @var			object			an instance of FetchTweets_AdminPageFramework_Messages will be assigned in the constructor.
    */	
	protected $oMsg;
	...
	* @since			2.0.0
	* @access		protected
	* @var			object			an instance of FetchTweets_AdminPageFramework_Link will be assigned in the constructor.
    */		
	protected $oLink;
	...
	* @since			2.0.0
	* @access		protected
	* @var			object			an instance of FetchTweets_AdminPageFramework_Utilities will be assigned in the constructor.
    */			
	protected $oUtil;
	 ...
	 * @since			2.1.5
	 * @access			protected
	 * @var				object			an instance of FetchTweets_AdminPageFramework_HeadTag_Pages will be assigne in the constructor.
	 */
	protected $oHeadTag;
	...
	public function __construct( $strOptionKey=null, $strCallerPath=null, $strCapability=null, $strTextDomain=null ){
		...
		// Objects
		$this->oProps = new FetchTweets_AdminPageFramework_Properties( $this, $strClassName, $strOptionKey, $strCapability );
		$this->oMsg = new FetchTweets_AdminPageFramework_Messages( $strTextDomain );
		$this->oUtil = new FetchTweets_AdminPageFramework_Utilities;
		$this->oDebug = new FetchTweets_AdminPageFramework_Debug;
		$this->oLink = new FetchTweets_AdminPageFramework_Link( $this->oProps, $strCallerPath );
		$this->oHeadTag = new FetchTweets_AdminPageFramework_HeadTag_Pages( $this->oProps );
	...
	*/	
	private function addSubMenuItem( $arrSubMenuItem ) {
		if ( isset( $arrSubMenuItem['strURL'] ) ) {
			$arrSubMenuLink = $arrSubMenuItem + FetchTweets_AdminPageFramework_Link::$arrStructure_SubMenuLink;
...
if ( ! class_exists( 'FetchTweets_AdminPageFramework_Messages' ) ) :
/**
 ...
 */
class FetchTweets_AdminPageFramework_Messages {
...
if ( ! class_exists( 'FetchTweets_AdminPageFramework_Properties_Base' ) ) :
 ...
 * @subpackage		Admin Page Framework - Property
 */ 
abstract class FetchTweets_AdminPageFramework_Properties_Base {
	...
	function __construct( $oCaller ) {
		...
		$GLOBALS['arrFetchTweets_AdminPageFramework'] = isset( $GLOBALS['arrFetchTweets_AdminPageFramework'] ) && is_array( $GLOBALS['arrFetchTweets_AdminPageFramework'] ) 
			? $GLOBALS['arrFetchTweets_AdminPageFramework']
			: array();
...
if ( ! class_exists( 'FetchTweets_AdminPageFramework_MetaBox_Properties' ) ) :
/**
 ...
 * @package			Admin Page Framework
 * @subpackage		Admin Page Framework - Property
 * @extends			FetchTweets_AdminPageFramework_Properties_Base
 */
class FetchTweets_AdminPageFramework_MetaBox_Properties extends FetchTweets_AdminPageFramework_Properties_Base {
...
if ( ! class_exists( 'FetchTweets_AdminPageFramework_PostType_Properties' ) ) :
/**
 ...
 * @extends			FetchTweets_AdminPageFramework_Properties_Base
 */
class FetchTweets_AdminPageFramework_PostType_Properties extends FetchTweets_AdminPageFramework_Properties_Base {
	
	/**
	 * Stores the post type slug.
	 * @since			2.0.0
	 * @since			2.1.0			Moved to FetchTweets_AdminPageFramework_PostType_Properties.
	 * @var				string
	 * @access			public
	 */ 
	public $strPostType = '';
...
if ( ! class_exists( 'FetchTweets_AdminPageFramework_Properties' ) ) :
/**
 ...
 * @extends			FetchTweets_AdminPageFramework_Properties_Base
 */
class FetchTweets_AdminPageFramework_Properties extends FetchTweets_AdminPageFramework_Properties_Base {
	...
	/**
	 * Construct the instance of FetchTweets_AdminPageFramework_Properties class object.
	 * 
	 * @remark			Used by the showInPageTabs() method.
	 * @since			2.0.0
	 ...
	 * 
	 * @since			2.0.0
	 * @since			2.1.5			Made it public and moved from the FetchTweets_AdminPageFramework_Pages class since this method is used by the FetchTweets_AdminPageFramework_HeadTab class as well.
	 * @internal
...
if ( ! class_exists( 'FetchTweets_AdminPageFramework_CustomSubmitFields' ) ) :
/**
 ...
 */
abstract class FetchTweets_AdminPageFramework_CustomSubmitFields {
...
if ( ! class_exists( 'FetchTweets_AdminPageFramework_ImportOptions' ) ) :
/**
 * Provides methods to import option data.
 *
 * @since			2.0.0
 * @extends			FetchTweets_AdminPageFramework_CustomSubmitFields
 * @package			Admin Page Framework
 * @subpackage		Admin Page Framework - Setting
 */
...
if ( ! class_exists( 'FetchTweets_AdminPageFramework_ExportOptions' ) ) :
/**
		...
		switch ( strtolower( $strFormatType ) ) {
			case 'text':	// for plain text.
				if ( is_array( $vData ) || is_object( $vData ) ) {
					$oDebug = new FetchTweets_AdminPageFramework_Debug;
...
if ( ! class_exists( 'FetchTweets_AdminPageFramework_LinkBase' ) ) :
/**
 * Provides methods for HTML link elements.
 *
 * @abstract
 * @since			2.0.0
 * @extends			FetchTweets_AdminPageFramework_Utilities
 * @package			Admin Page Framework
 * @subpackage		Admin Page Framework - Link
 */
abstract class FetchTweets_AdminPageFramework_LinkBase extends FetchTweets_AdminPageFramework_Utilities {
...
if ( ! class_exists( 'FetchTweets_AdminPageFramework_LinkForPostType' ) ) :
/**
 ...
 * @subpackage		Admin Page Framework - Link
 */
class FetchTweets_AdminPageFramework_LinkForPostType extends FetchTweets_AdminPageFramework_LinkBase {
	
	/**
	 * Stores the information to embed into the page footer.
	 * @since			2.0.0
	 * @remark			This is accessed from the FetchTweets_AdminPageFramework_PostType class.
	 */ 
	public $arrFooterInfo = array(
		'strLeft' => '',
		'strRight' => '',
...
if ( ! class_exists( 'FetchTweets_AdminPageFramework_Link' ) ) :
/**
 ...
 * 
 * @since			2.0.0
 * @extends			FetchTweets_AdminPageFramework_LinkBase
 * @package			Admin Page Framework
 * @subpackage		Admin Page Framework - Link
 */
class FetchTweets_AdminPageFramework_Link extends FetchTweets_AdminPageFramework_LinkBase {
...
if ( ! class_exists( 'FetchTweets_AdminPageFramework_Debug' ) ) :
/**
 ...
 * @subpackage		Admin Page Framework - Utility
 */
class FetchTweets_AdminPageFramework_Debug {
...
if ( ! class_exists( 'FetchTweets_AdminPageFramework_InputFieldType_Base' ) ) :
/**
 ...
 * @since			2.1.5
 */
abstract class FetchTweets_AdminPageFramework_InputFieldTypeDefinition_Base extends FetchTweets_AdminPageFramework_Utilities {
	 ...
	 * 
	 * @remark			The scope is public since FetchTweets_AdminPageFramework_CustomFieldType class allows the user to use this method.
	 * @since			2.1.5
	 */
...
if ( ! class_exists( 'FetchTweets_AdminPageFramework_CustomFieldType' ) ) :
/**
 ...
 * @since			2.1.5
 */
abstract class FetchTweets_AdminPageFramework_CustomFieldType extends FetchTweets_AdminPageFramework_InputFieldTypeDefinition_Base {}
endif;

if ( ! class_exists( 'FetchTweets_AdminPageFramework_InputFieldType_default' ) ) :
/**
 ...
 * @since			2.1.5
 */
class FetchTweets_AdminPageFramework_InputFieldType_default extends FetchTweets_AdminPageFramework_InputFieldTypeDefinition_Base {
...
if ( ! class_exists( 'FetchTweets_AdminPageFramework_InputFieldType_text' ) ) :
/**
 ...
 * @since			2.1.5
 */
class FetchTweets_AdminPageFramework_InputFieldType_text extends FetchTweets_AdminPageFramework_InputFieldTypeDefinition_Base {
...
if ( ! class_exists( 'FetchTweets_AdminPageFramework_InputFieldType_number' ) ) :
/**
 ...
 * @since			2.1.5
 */
class FetchTweets_AdminPageFramework_InputFieldType_number extends FetchTweets_AdminPageFramework_InputFieldTypeDefinition_Base {
...
if ( ! class_exists( 'FetchTweets_AdminPageFramework_InputFieldType_textarea' ) ) :
/**
 ...
 * @since			2.1.5
 */
class FetchTweets_AdminPageFramework_InputFieldType_textarea extends FetchTweets_AdminPageFramework_InputFieldTypeDefinition_Base {
	...
	public function replyToGetInputField( $vValue, $arrField, $arrOptions, $arrErrors, $arrFieldDefinition ) {
		 ...
		 * 
		 * @since			2.1.2
		 * @since			2.1.5			Moved from FetchTweets_AdminPageFramework_InputField.
		 */	
...
if ( ! class_exists( 'FetchTweets_AdminPageFramework_InputFieldType_color' ) ) :
/**
 ...
 * @since			2.1.5
 */
class FetchTweets_AdminPageFramework_InputFieldType_color extends FetchTweets_AdminPageFramework_InputFieldTypeDefinition_Base {
	 ...
	 * @since			2.0.0
	 * @since			2.1.5			Moved from FetchTweets_AdminPageFramework_MetaBox. Changed the name from enqueueColorFieldScript().
...
if ( ! class_exists( 'FetchTweets_AdminPageFramework_InputFieldType_date' ) ) :
/**
 ...
 * @since			2.1.5
 */
class FetchTweets_AdminPageFramework_InputFieldType_date extends FetchTweets_AdminPageFramework_InputFieldTypeDefinition_Base {
	 ...
	 * @since			2.0.0
	 * @simce			2.1.5			Moved from FetchTweets_AdminPageFrameworkMeta. Changed the name from enqueueDateFieldScript().
	 */ 
	public function replyToFieldLoader() {
...
if ( ! class_exists( 'FetchTweets_AdminPageFramework_InputFieldType_image' ) ) :
/**
 ...
 * @since			2.1.5
 */
class FetchTweets_AdminPageFramework_InputFieldType_image extends FetchTweets_AdminPageFramework_InputFieldTypeDefinition_Base {
	...
	protected function enqueueMediaUploader() {
		 ...
		 * 
		 * since			2.1.3
		 * since			2.1.5			Moved from FetchTweets_AdminPageFramework_SettingsAPI. Changed the name from removeMediaLibraryTab() to replyToRemovingMediaLibraryTab().
	...
	public function replyToGetInputScripts() {
		 ...
		 * @remark			Used by the image and media field types.
		 * @since			2.1.3
		 * @since			2.1.5			Moved from FetchTweets_AdminPageFramework_Properties_Base.
		 */
		protected function getScript_CustomMediaUploaderObject() {
			
			 $fLoaded = isset( $GLOBALS['arrFetchTweets_AdminPageFramework']['fIsLoadedCustomMediaUploaderObject'] )
				? $GLOBALS['arrFetchTweets_AdminPageFramework']['fIsLoadedCustomMediaUploaderObject'] : false;
			
			if( ! function_exists( 'wp_enqueue_media' ) || $fLoaded )	// means the WordPress version is 3.4.x or below
				return "";
			
			$GLOBALS['arrFetchTweets_AdminPageFramework']['fIsLoadedCustomMediaUploaderObject'] = true;
		 ...
		 * @return			string			The image selector script.
		 * @since			2.0.0
		 * @since			2.1.5			Moved from the FetchTweets_AdminPageFramework_Properties_Base class. Changed the name from getImageSelectorScript(). Changed the scope to private and not static anymore.
		 */		
	...
	public function replyToGetInputField( $vValue, $arrField, $arrOptions, $arrErrors, $arrFieldDefinition ) {
		 ...
		 * 
		 * @since			2.1.3
		 * @since			2.1.5			Moved from FetchTweets_AdminPageFramework_InputField. Added some parameters.
		 */
...
if ( ! class_exists( 'FetchTweets_AdminPageFramework_InputFieldType_media' ) ) :
/**
 ...
 * @since			2.1.5
 */
class FetchTweets_AdminPageFramework_InputFieldType_media extends FetchTweets_AdminPageFramework_InputFieldType_image {
...
if ( ! class_exists( 'FetchTweets_AdminPageFramework_InputFieldType_select' ) ) :
/**
 ...
 * @since			2.1.5
 */
class FetchTweets_AdminPageFramework_InputFieldType_select extends FetchTweets_AdminPageFramework_InputFieldTypeDefinition_Base {
...
if ( ! class_exists( 'FetchTweets_AdminPageFramework_InputFieldType_radio' ) ) :
/**
 ...
 * @since			2.1.5
 */
class FetchTweets_AdminPageFramework_InputFieldType_radio extends FetchTweets_AdminPageFramework_InputFieldTypeDefinition_Base {
	...
	public function replyToGetInputField( $vValue, $arrField, $arrOptions, $arrErrors, $arrFieldDefinition ) {
		 ...
		 * @since			2.0.0
		 * @since			2.1.5			Moved from FetchTweets_AdminPageFramework_InputField. Added the $arrField, $strFieldName, $arrDefaultKeys, $strTagID, and $vValue parameter.
		 */ 
...
if ( ! class_exists( 'FetchTweets_AdminPageFramework_InputFieldType_checkbox' ) ) :
/**
 ...
 * @since			2.1.5
 */
class FetchTweets_AdminPageFramework_InputFieldType_checkbox extends FetchTweets_AdminPageFramework_InputFieldTypeDefinition_Base {
...
if ( ! class_exists( 'FetchTweets_AdminPageFramework_InputFieldType_size' ) ) :
/**
 ...
 * @since			2.1.5
 */
class FetchTweets_AdminPageFramework_InputFieldType_size extends FetchTweets_AdminPageFramework_InputFieldTypeDefinition_Base {
	 ...
	 * 
	 * @since			2.0.1
	 * @since			2.1.5			Moved from FetchTweets_AdminPageFramework_InputField. Changed the name from getSizeField().
	 */
	public function replyToGetInputField( $vValue, $arrField, $arrOptions, $arrErrors, $arrFieldDefinition ) {
...
if ( ! class_exists( 'FetchTweets_AdminPageFramework_InputFieldType_hidden' ) ) :
/**
 ...
 * @since			2.1.5
 */
class FetchTweets_AdminPageFramework_InputFieldType_hidden extends FetchTweets_AdminPageFramework_InputFieldTypeDefinition_Base {
	 ...
	 * 
	 * @since			2.0.0
	 * @since			2.1.5				Moved from the FetchTweets_AdminPageFramework_InputField class. The name was changed from getHiddenField().
	 */
	public function replyToGetInputField( $vValue, $arrField, $arrOptions, $arrErrors, $arrFieldDefinition ) {
...
if ( ! class_exists( 'FetchTweets_AdminPageFramework_InputFieldType_file' ) ) :
/**
 ...
 * @since			2.1.5
 */
class FetchTweets_AdminPageFramework_InputFieldType_file extends FetchTweets_AdminPageFramework_InputFieldTypeDefinition_Base {
...
if ( ! class_exists( 'FetchTweets_AdminPageFramework_InputFieldType_posttype' ) ) :
/**
 ...
 * @since			2.1.5
 */
class FetchTweets_AdminPageFramework_InputFieldType_posttype extends FetchTweets_AdminPageFramework_InputFieldTypeDefinition_Base {
	...
	public function replyToGetInputField( $vValue, $arrField, $arrOptions, $arrErrors, $arrFieldDefinition ) {
		 ...
		 * @since			2.1.5			Moved from FetchTweets_AdminPageFramework_InputTag.
...
if ( ! class_exists( 'FetchTweets_AdminPageFramework_InputFieldType_taxonomy' ) ) :
/**
 ...
 * @since			2.1.5
 */
class FetchTweets_AdminPageFramework_InputFieldType_taxonomy extends FetchTweets_AdminPageFramework_InputFieldTypeDefinition_Base {
				...
				"<div id='tab-{$strKey}' class='tab-box-content' style='height: {$arrField['strHeight']};'>"
					. "<ul class='list:category taxonomychecklist form-no-clear'>"
						. wp_list_categories( array(
							'walker' => new FetchTweets_AdminPageFramework_WalkerTaxonomyChecklist,	// the walker class instance
...
if ( ! class_exists( 'FetchTweets_AdminPageFramework_InputFieldType_submit' ) ) :
/**
 ...
 * @since			2.1.5
 */
class FetchTweets_AdminPageFramework_InputFieldType_submit extends FetchTweets_AdminPageFramework_InputFieldTypeDefinition_Base {
	 ...
	 * @since			2.0.0
	 * @since			2.1.5			Made the parameter mandatory. Changed the scope to protected from private. Moved from FetchTweets_AdminPageFramework_InputField.
	 */ 
...
if ( ! class_exists( 'FetchTweets_AdminPageFramework_InputFieldType_export' ) ) :
/**
 ...
 * @since			2.1.5
 */
class FetchTweets_AdminPageFramework_InputFieldType_export extends FetchTweets_AdminPageFramework_InputFieldType_submit {
	...
	public function replyToGetInputField( $vValue, $arrField, $arrOptions, $arrErrors, $arrFieldDefinition ) {
		 ...
		 * @since			2.0.0
		 * @since			2.1.5			Moved from the FetchTweets_AdminPageFramework_InputField class.
		 */ 
...
if ( ! class_exists( 'FetchTweets_AdminPageFramework_InputFieldType_import' ) ) :
/**
 ...
 * @since			2.1.5
 */
class FetchTweets_AdminPageFramework_InputFieldType_import extends FetchTweets_AdminPageFramework_InputFieldType_submit {
...
if ( ! class_exists( 'FetchTweets_AdminPageFramework_InputFieldTypeDefinitions' ) ) :
/**
 ...
 * @since			2.1.5
 */
class FetchTweets_AdminPageFramework_InputFieldTypeDefinitions  {
	...
	function __construct( $strExtendedClassName, $oMsg ) {
		...
		foreach( self::$arrDefaultFieldTypeSlugs as $strFieldTypeSlug ) {
			$strInstantiatingClassName = "FetchTweets_AdminPageFramework_InputFieldType_{$strFieldTypeSlug}";
...
if ( ! class_exists( 'FetchTweets_AdminPageFramework_InputField' ) ) :
/**
 ...
 * @subpackage		Admin Page Framework - Setting
 */
class FetchTweets_AdminPageFramework_InputField extends FetchTweets_AdminPageFramework_Utilities {
	...
	public function __construct( &$arrField, &$arrOptions, $arrErrors, &$arrFieldDefinition ) {
		...
		// Global variable
		$GLOBALS['arrFetchTweets_AdminPageFramework']['arrFieldFlags'] = isset( $GLOBALS['arrFetchTweets_AdminPageFramework']['arrFieldFlags'] )
			? $GLOBALS['arrFetchTweets_AdminPageFramework']['arrFieldFlags'] 
			: array();
...
if ( ! class_exists( 'FetchTweets_AdminPageFramework_WalkerTaxonomyChecklist' ) ) :
/**
...
if ( ! class_exists( 'FetchTweets_AdminPageFramework_PostType' ) ) :
/**
 ...
 */
abstract class FetchTweets_AdminPageFramework_PostType {	
	...
	/**
	* Constructs the class object, FetchTweets_AdminPageFramework_PostType.
	* 
	* <h4>Example</h4>
	...
	*/
	public function __construct( $strPostType, $arrArgs=array(), $strCallerPath=null ) {
		...
		// Objects
		$this->oUtil = new FetchTweets_AdminPageFramework_Utilities;
		$this->oProps = new FetchTweets_AdminPageFramework_PostType_Properties( $this );
		...
		if ( $this->oProps->strPostType != '' && is_admin() ) {			
			...
			// Links
			$this->oLink = new FetchTweets_AdminPageFramework_LinkForPostType( $this->oProps->strPostType, $this->oProps->strCallerPath );
...
if ( ! class_exists( 'FetchTweets_AdminPageFramework_MetaBox' ) ) :
/**
 ...
 */
abstract class FetchTweets_AdminPageFramework_MetaBox extends FetchTweets_AdminPageFramework_MetaBox_Help {
	...
	*/ 		
	...
	/**
	 * Constructs the class object instance of FetchTweets_AdminPageFramework_MetaBox.
	 * 
	 * @see				http://codex.wordpress.org/Function_Reference/add_meta_box#Parameters
	 * @since			2.0.0
	...
	function __construct( $strMetaBoxID, $strTitle, $vPostTypes=array( 'post' ), $strContext='normal', $strPriority='default', $strCapability='edit_posts', $strTextDomain='admin-page-framework' ) {
		...
		$this->oMsg = new FetchTweets_AdminPageFramework_Messages( $strTextDomain );
		$this->oDebug = new FetchTweets_AdminPageFramework_Debug;
		$this->oProps = new FetchTweets_AdminPageFramework_MetaBox_Properties( $this );
		$this->oHeadTag = new FetchTweets_AdminPageFramework_HeadTag_MetaBox( $this->oProps );
	...
	*/		
	protected function addSettingField( $arrField ) {
		...
		$arrField = $arrField + FetchTweets_AdminPageFramework_MetaBox_Properties::$arrStructure_Field;	// avoid undefined index warnings.
	...
	public function echoMetaBoxContents( $oPost, $vArgs ) {	
		...
		foreach ( ( array ) $vArgs['args'] as $arrField ) {
			...
			// Avoid undefined index warnings
			$arrField = $arrField + FetchTweets_AdminPageFramework_MetaBox_Properties::$arrStructure_Field;
	...
	private function getFieldOutput( $arrField ) {
		...
		$strFieldType = isset( $this->oProps->arrFieldTypeDefinitions[ $arrField['strType'] ]['callRenderField'] ) && is_callable( $this->oProps->arrFieldTypeDefinitions[ $arrField['strType'] ]['callRenderField'] )
			? $arrField['strType']
			: 'default';	// the predefined reserved field type is applied if the parsing field type is not defined(not found).
		$oField = new FetchTweets_AdminPageFramework_InputField( $arrField, $this->oProps->arrOptions, array(), $this->oProps->arrFieldTypeDefinitions[ $strFieldType ] );	// currently the error array is not supported for meta-boxes
