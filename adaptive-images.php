...
$resolutions   = array(1280, 1080, 768, 640, 480, 320); // the resolution break-points to use (screen widths, in pixels)
$cache_path    = "/storm/ai-cache"; // where to store the generated re-sized images. Specify from your document root!
