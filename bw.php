  ...
  <body><!-- hello -->
    ...
    <div id="root">
      <div id="page" class="simple bearweekend"><a href="index.php"><img src="images/logo.svg" alt="logo" class="logo"></a>
        <section class="intro">
          <article><a href="http:/www.sfbearweekend.com"><img src="images/events/sfbw_paw.jpg" alt="bearpaw" class="flyer"></a>
            <p><span class="bigtype">SF&nbsp;Bear&nbsp;Weekend&nbsp;(2.0)</span></p>
            <p>All truly amazing things must come to an end.<a href="http://en.wikipedia.org/wiki/Bear_Magazine"> BEAR</a> -- The zine that started it all. Pre-earthquake<a href="http://en.wikipedia.org/wiki/Rick_Redewill"> Lone Star Saloon</a> -- The bar that first recognized the beauty in hairy men. Harrison Street Fair. Those first two years were unforgettable. And
            ...
            <p>
              The Last IBR was in 2011 and San Francisco, Bear Mecca, was left without a single Bear gathering. In 2013, a new type of a great
            ...
            <p>
              ...
              have planned a few events this weekend. You'll find even more choices over at<a href="http://www.sfbearweekend.com"> SFBearWeekend.com</a> including information on where to stay and where to meet the ball of fur of your dreams.
            </p>
