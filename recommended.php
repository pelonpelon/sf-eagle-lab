...
<html>
  ...
  <body><!-- hello -->
    <!-- #background-->
    <div id="root">
      <div id="page" class="simple recommended"><a href="index.php"><img src="images/logo.svg" alt="logo" class="logo"></a>
        <div class="content">
          <header class="cf"><span>•RECOMMENDED•</span></header>
          <section><?php
  global $post;
  $category_id = get_cat_ID('Recommended');
  $args = array(
  ...
  foreach($posts as $post)
  {
    ...
    <div class="recommended-content"><?php the_content(); ?></div>
